# This is a Pygame UI visualization script, not a test
# It should not be collected by pytest
# If you want to keep it, rename to exclude 'test_' prefix
# For now, converting to a standalone script
...
if __name__ == "__main__":
    try:
        ...
        print("⚠️ Pygame not available. This is a visualization script and requires: pip install pygame")
        sys.exit(1)
